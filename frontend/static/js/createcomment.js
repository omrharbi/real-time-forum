      ...
      div.innerHTML = /*html*/`
          ...
          data.date
                                ...
                                <div class="post-actions">
                                    <div class="action active is_liked" data-context="comment" id="likes"  data-uuid="${data.user_uuid}" data-like="like" data-id_card="${data.card_id
        }" >
                                    ...
                                    <div class="action disliked" id="likes" data-liked="false"  data-like="Dislikes" data-uuid="${data.user_uuid}" data-id_card="${data.card_id}">
                                        <svg width="17" height="17" viewBox="0 0 20 20" fill="currentColor">
    ...
    click.addEventListener("click", async (e) => {
      ...
      try {
        ...
        if (response.ok) {
          ...
          let cardElement = click.closest(".commens-card");
