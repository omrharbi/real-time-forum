      ...
      div.innerHTML = /*html*/`
          ...
          data.date
                                ...
                                <div class="post-actions">
                                    <div class="action active is_liked" data-context="comment" id="likes" data-liked="false" data-like="like" data-id_card="${data.user_uuid
                                    ...
                                    <div class="action disliked" id="likes" data-liked="false"  data-like="Dislikes" data-id_card="${data.user_uuid
}">
                                        <svg width="17" height="17" viewBox="0 0 20 20" fill="currentColor">
...
async function fetchCard() {
  try {
    let cardId = document.getAttribute("data-id_card");
