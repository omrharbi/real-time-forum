...
export function createPos(ele) {  
  ...
  contents.innerHTML = `
        <div class="post commens-card">
          <div class="post-header">
            <img src="../static/imgs/profilePic.png" class="avatar" alt="${ele.firstName
    }'s profile picture" />
            <div class="user-info">
              <div class="display-name">${ele.firstName + " " + ele.lastName
    }</div>
          ...
          <div class="post-actions">
            <div class="action active is_liked" data-context="post" id="likes" data-liked="false" data-like="like" data-id_card="${ele.id
             ...
             <div class="action disliked" data-context="post" id="likes" data-liked="false"  data-like="Dislikes" data-id_card="${ele.id
              ...
              <span id="is_Dislikes" data-disliked="disliked">${ele.dislikes
    }</span>
            </div>
              <span class="link">
            <div class="action">
  ...
  const like = contents.querySelector(".is_liked");
